...
namespace AuthSystem.Areas.Identity.Data.Migrations
{
    ...
    [Migration("20231206221723_EditEmployeeProfile")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.AccessLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.Employee", b =>
                {
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.EmployeeProfile", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.MilitaryRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.Vacation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.WorkHour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.AccessLog", b =>
                {
                    b.HasOne("AuthSystem.Areas.Identity.Data.Entities.User", "User")
                        .WithMany("AccessLogs")
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.Employee", b =>
                {
                    b.HasOne("AuthSystem.Areas.Identity.Data.Entities.Post", "Post")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.EmployeeProfile", b =>
                {
                    b.HasOne("AuthSystem.Areas.Identity.Data.Entities.Employee", "Employee")
                        .WithOne("EmployeeProfile")
                        .HasForeignKey("AuthSystem.Areas.Identity.Data.Entities.EmployeeProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.Post", b =>
                {
                    b.HasOne("AuthSystem.Areas.Identity.Data.Entities.Department", "Department")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("AuthSystem.Areas.Identity.Data.Entities.User", b =>
                {
                    b.HasOne("AuthSystem.Areas.Identity.Data.Entities.Employee", "Employee")
                        .WithOne("User")
                        .HasForeignKey("AuthSystem.Areas.Identity.Data.Entities.User", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AuthSystem.Areas.Identity.Data.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
