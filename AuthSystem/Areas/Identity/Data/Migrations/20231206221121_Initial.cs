...
namespace AuthSystem.Areas.Identity.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_asp_net_users_employees_id",
                        column: x => x.id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    family_status = table.Column<string>(type: "text", nullable: false),
                    ...
                    passport_issue_by = table.Column<string>(type: "text", nullable: false),
                    passport_expiration_date = table.Column<DateOnly>(type: "date", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "military_registrations",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    military_rank = table.Column<string>(type: "text", nullable: false),
                    registration_date = table.Column<DateOnly>(type: "date", nullable: false),
                    employee_id = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_military_registrations", x => x.id);
                    table.ForeignKey(
                        name: "fk_military_registrations_employees_employee_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_work_hours_employees_employee_id",
                        column: x => x.employee_id,
                        principalTable: "employees",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    log_out_time = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_military_registrations_employee_id",
                table: "military_registrations",
                column: "employee_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_work_hours_employee_id",
                table: "work_hours",
                column: "employee_id");
        }
